...
class _GeneralFixState extends State<GeneralFix> {
  ...
  void initState() {
    gettoken();
    this.getGeneralFixF(key: '1234567890', token_id: widget.jwt, cat_id: widget.cat_id);
    super.initState();
  }
  Dio dio=Dio();
  ...
  Widget build(BuildContext context) {
    ...
    return Material(
      child: StreamBuilder<GeneralFixM>(
        stream: _repo.getGeneralFixF(key: '1234567890', token_id: widget.jwt, cat_id: widget.cat_id).asStream(),
