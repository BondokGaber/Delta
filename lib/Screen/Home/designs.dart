    ...
    return Scaffold(
     ...
     body:  Container(
         ...
         child: StreamBuilder<ProjectsM>(
           stream: _repo.getProjects(key: "1234567890", token_id: token, limit: '20', page_number: '0')
             .asStream(),
               ...
               return Directionality(
                 ...
                 child: GridView.builder(
                   ...
                   itemBuilder: (BuildContext context, int index){
                     for (int i = 0; i < snapshot.data.result.allProjects[index].allSlider.length; i++) {
                             ...
                             child: Column(
                               ...
                               //   Image.network(snapshot.data.result.allProjects[index].articlesImage),
                                 Padding(
                                   ...
                                   child: Container(
                                     child: Text(snapshot.data.result.allProjects[index].projectName ,textDirection: TextDirection.rtl,
                                       style: TextStyle(
                                         fontFamily: 'GE SS Two',
                                         fontSize: 13,
                                         fontWeight: FontWeight.w300,
                                 ...
                                 Padding(
                                   ...
                                   child: Container(
                                     child: Row(
                                       ...
                                       children: [
                                         Text('معلومات عن الموقع' ,textDirection: TextDirection.rtl,
                                           style: TextStyle(
                                             fontFamily: 'GE SS Two',
                                             fontSize: 13,
                                             fontWeight: FontWeight.w300,
                                 ...
                                 Expanded(
                                   child: Padding(
                                     padding: const EdgeInsets.all(5.0),
                                     child: Container(
                                       child: Text(snapshot.data.result.allProjects[index].smallDescription ,textDirection: TextDirection.rtl,
                                         style: TextStyle(
                                           fontFamily: 'GE SS Two',
                                           fontSize: 13,
                                           fontWeight: FontWeight.w300,
                                 ...
                                 Container(
                                   child: ElevatedButton(
                                       ...
                                       onPressed: () {
                                         ...
                                         Navigator.push(context, MaterialPageRoute(builder: (_)=>ProjectDetails(proId: snapshot.data.result.allProjects[index].projectId.toString(),)));
                                       }
                                   ),
                                 ),
                               ],
