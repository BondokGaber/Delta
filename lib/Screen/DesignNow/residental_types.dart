  ...
  Widget build(BuildContext context) {
    ...
    return Material(
      child: StreamBuilder<ResidentialTypesM>(
          stream: _repo.getResidentialTypesF(key: '1234567890', token_id: widget.jwt, cat_id: widget.cat_id).asStream(),
                          ...
                          child: Row(
                            ...
                            children: [
                              Container(
                                ...
                                width: sWidth*.9,
                                child: Text(
                                  "${snapshot.data.result.categoryDate.title}",   textDirection: TextDirection.rtl,
                                  style: TextStyle(
                                    fontFamily: 'GE SS Two',
                                    fontSize: 17,
                                    fontWeight: FontWeight.w300,
                          ...
                          child: Container(
                            ...
                            child: ConstrainedBox(
                              ...
                              child: ElevatedButton(
                                  ...
                                  onPressed: () {
                                    Navigator.push(context, MaterialPageRoute(builder: (_)=>ArchResidentialDesign(jwt: token,cat_id: snapshot.data.result.lableList[0].lebalId.toString(),)));
                                  }
                              ),
                            ),
                          ),
                              ...
                              child: ElevatedButton(
                                  ...
                                  onPressed: () {
                                    Navigator.push(context, MaterialPageRoute(builder: (
                                        _) => ConstResidenial(cat_id: snapshot.data.result.lableList[1].lebalId.toString(),jwt: token,)));
                                  }
                              ),
                            ),
                          ),
                          ...
                          child: Row(
                            ...
                            children: [
                              Container(
                                ...
                                width: sWidth*.9,
                                child: Text(
                                  "${snapshot.data.result.categoryDate.details}",   textDirection: TextDirection.rtl,
                                  style: TextStyle(
                                    fontFamily: 'GE SS Two',
                                    fontSize: 17,
                                    fontWeight: FontWeight.w300,
