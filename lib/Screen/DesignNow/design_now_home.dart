  ...
  Widget build(BuildContext context) {
    ...
    return Material(
      child: StreamBuilder<DesignNowM>(
        stream: _repo.getDesignNowF(key: '1234567890', token_id: widget.jwt, cat_id: widget.cat_id).asStream(),
                          ...
                          child: ConstrainedBox(
                            ...
                            child: ElevatedButton(
                                ...
                                onPressed: () {
                                  ...
                                  Navigator.push(context, MaterialPageRoute(builder: (_)=>ResidentialTypes(cat_id:snapshot.data.result.lableList[0].lebalId.toString() ,jwt: token,)));
                                }
                            ),
                          ),
                        ),
                            ...
                            child: ElevatedButton(
                                ...
                                onPressed: () {
                                  Navigator.push(context, MaterialPageRoute(builder: (
                                      _) => CommercialDesign(jwt: token,cat_id:snapshot.data.result.lableList[1].lebalId.toString() ,)));
                                }
                            ),
                          ),
                        ),
